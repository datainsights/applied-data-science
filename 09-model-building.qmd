...
scatter = plt.scatter(
    ...
    c=results_df["error"],
    cmap="viridis",          # strong contrast
    edgecolors="black",      # separation between points
    linewidth=0.4,
    alpha=0.9
)
...
This plot helps us move beyond a single metric.

If the model performs well, predictions should generally align with observed values.

If they are widely scattered, then the model is capturing only part of the signal.

---

## Inspect Coefficients Carefully

Linear regression also gives us coefficients for each feature.
