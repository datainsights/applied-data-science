...
A[CDI Open Guides<br/>Learn the foundations] --> B[System Build 01<br/>Data Science]

B --> C[Raw Data]
C --> D[Data Understanding]
D --> E[Cleaning & Preparation]
...
J --> K[Portfolio Proof<br/>Reproducible repo + Quarto report]
K --> L[Mentorship Review<br/>Feedback + refinement]
L --> M[Deployment / DevOps Track<br/>APIs, apps, monitoring]

B --> N[System Build Template]
N --> O[System Build 02<br/>Bioinformatics]
N --> P[System Build 03<br/>Clinical Data]
N --> Q[System Build 04<br/>Business Analytics]
```